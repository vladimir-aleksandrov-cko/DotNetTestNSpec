...
var packFiles = "./src/DotNetTestNSpec/*.csproj";
...
Setup(context =>
{
    ...
    Information("Building NspecTestAdapter v{0} with configuration {1}", nugetVersion, configuration);
});
...
Task("__Pack")
    .Does(() => 
    {
        var settings = new DotNetCorePackSettings 
        {
            ...
            NoBuild = true,
            ArgumentCustomization = args => args.Append($"/p:Version={nugetVersion}+{gitVersionInfo.Sha}")
        };
